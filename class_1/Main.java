...
public class Main {
  ...
  //  - void:   Indica que o método não retorna valores (i.e. é um procedimento)
  //  - String[]: Um conjunto de Textos
  public static void main(String[] args) {
    // Para exibir textos em um Console há o método System.out.println("texto")
    System.out.println("Hello, World!");

    // Declaração das variáveis
    // Declarar uma variável significa apenas dizer que ela existe neste
    // contexto.
    // Em Java uma variável pode ser declarada em qualquer ponto dentro de um
    // método. Para tipos primitivos numéricos (int, double, float, byte...),
    // quando um valor não é dado de início, a variável é inicializada com 0.
    int x;
    int y;
    int z;
    ...
    // Porém as linguagens de programação não permitem as duas comparações de
    // uma vez só (i.e. não é possível escrever "if (0 < z < 4)"), portanto,
    // é preciso fazer as comparações uma a uma.
